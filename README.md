<h1 align="center"> 🚀 PHP Básico </h1>

## ✍️ Descrição
Exemplificação da sintaxe geral e básica da Linguagem PHP
...
1. Clone:
    ...
    ```bash
    git clone git@github.com:cleibp/basic-php.git
    ```
1. Download:
    ### Download Manual
...
## 👋🏽 DEMO
[REPLIT](https://replit.com/@cleibp/Basic-PHP) 
